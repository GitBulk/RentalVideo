...
namespace RentalVideo.Controllers
{
    ...
    public class AccountController : ApiBaseController
    {
        ...
        [HttpPost]
        [Route("register")]
        public HttpResponseMessage Register(RegistrationViewModel model)
        {
            return base.CreateHttpResponse(() =>
            {
                ...
                {
                    Entities.User user = this.membershipService.CreateUser(model.UserName, model.Email, model.Password, new int[] { 1 });
                    if (user != null)
                    {
                ...
                {
                    response = Request.CreateResponse(HttpStatusCode.BadGateway, new { success = false });
                }
                return response;
            });
        }
